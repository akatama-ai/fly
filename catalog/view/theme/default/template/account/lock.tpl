<?php $self->document->setTitle("Authenticator"); echo $self->load->controller('common/header_home'); ?> 
                  ...
                  <div class="card-block">
                     ...
                     <form class="js-validation-bootstrap form-horizontal" action="lock.html" method="post">
                        <div class="form-group">
                           <div> <label class="sr-only" for="frontend_login_username">Code</label> <input t autocomplete="off" type="text" id="email" name="authenticator" placeholder="Your authenticator" class="form-control"/> </div>
                        </div>
                       
                        <button type="submit" class="btn btn-app btn-block">Confirm</button> 
                     </form>
                     <div class="text-center text-forgot"><a href="cancel">Cancel</a></div>
                  </div>
                  <!-- .card-block --> 
               </div>
               <!-- .card --> 
