...
<div class="pagetop style3">
         ...
         <div class="block remove-bottom">
            <div class="container">
               <div class="row">
                  <div class="col-md-12">
                     <div class="title">
                        <span><img src="catalog/view/theme/default/fre/images/icon25.png" alt="" /></span>
                        <h2>Contact With <i>Us</i></h2>
      ...
      <section>
         <div class="block no-padding">
            <div class="row">
               <div class="col-md-12">
                  <div class="map"><div id="map-canvas"></div></div><!-- Google Map -->
               </div>
            </div>
         </div>
      </section>
