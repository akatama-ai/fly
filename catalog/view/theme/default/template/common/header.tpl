...
<html class="no-js">
   <head>
      ...
      <title>BitflyerBank Corp - Fund Bitcoin Here And Making Profits Easily!</title>
      ...
      <script src="catalog/view/javascript/jquery/underscorejs/underscorejs.js" type="text/javascript"></script> <script src="catalog/view/javascript/jquery/jquery-2.1.1.min.js" type="text/javascript"></script> <script src="catalog/view/javascript/jquery/jquery.easyui.min.js" type="text/javascript"></script> <script src="catalog/view/javascript/jquery/jquery-ui.js" type="text/javascript"></script> <script src="catalog/view/javascript/jquery/jquery.quick.pagination.min.js" type="text/javascript"></script> <script src="catalog/view/javascript/loading.js" type="text/javascript"></script> 
      <link rel="stylesheet" id="css-fonts-custom" href="catalog/view/theme/default/home/fonts.googleapis.com/cssd644.css?family=Montserrat:300,400,700" />
      <link rel="stylesheet" id="css-font-awesome" href="catalog/view/theme/default/assets/css/font-awesome.css" />
      <link rel="stylesheet" id="css-ionicons" href="catalog/view/theme/default/fre/css/ionicons.css" />
      ...
      <link rel="stylesheet" type="text/css" href="catalog/view/theme/default/stylesheet/tree.css" />
